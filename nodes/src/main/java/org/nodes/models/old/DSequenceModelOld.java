...
// *
// */
//public class DSequenceModelOld<L> implements Model<L, DGraph<L>>
//{
...
//	private double logNumGraphs, bitsUpperBound, bitsLowerBound;
//	
//	private double gradientStopCondition = 10E-4;
//	private double differenceStopCondition = 10E-4;
//
//	public DSequenceModelOld(DGraph<?> data, boolean check)
//	{
//		this(data, check, 0.1, 0.001);
//	}
//	public DSequenceModelOld(DGraph<?> data, boolean check, double gradientStop, double diffStop)
//	{
//		this.gradientStopCondition = gradientStop;
//		this.differenceStopCondition = diffStop;
//		
...
//			
//			if(gradient.getLInfNorm() < gradientStopCondition && xSteps.get(xSteps.size()-1).getNorm() < differenceStopCondition)
//				break;
//			
...
//		
//		logNumGraphs = 0.5 * bitsLowerBound + 0.5 * bitsUpperBound; 
//	}
//
//	/**
